...
export default function Forbidden() {
    return (
        <div className="flex flex-col items-center justify-center min-h-screen w-full bg-gradient-to-b from-rose-100 via-white to-cyan-100 dark:from-gray-800 dark:via-gray-900 dark:to-gray-800 p-6">
            {/* Logo */}
            <div className="flex items-center justify-center w-40 h-40 rounded-full border-4 border-gray-500 shadow-md bg-white dark:bg-transparent mb-6">
                <Image
            ...
            <Link
                href="/"
                className="rounded-2xl bg-gray-600 px-6 py-3 text-white font-semibold shadow-lg hover:scale-105 transition-transform">
                Volver al inicio
            </Link>
        </div>
    )
